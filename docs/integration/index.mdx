...
<Cards>
  ...
  >
    Build, run, and debug your UI on your computer straight from the Editor with the bundled `sim/` project.
  </Card>
  ...
  >
    A standalone desktop project for VS Code that you can extend with any extension.
  </Card>
</Cards>
