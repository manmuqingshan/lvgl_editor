...
The online viewer, along with the [Editor](./editor/overview), [CLI](./cli), and [Figma plugin](./figma), is part of **LVGL Pro**, a professional toolkit to develop embedded UIs.
