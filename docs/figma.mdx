...
The Figma plugin, along with the [Editor](./editor/overview), [CLI](./cli), and [online viewer](./online-viewer), is part of **LVGL Pro**, a professional toolkit to develop embedded UIs.
